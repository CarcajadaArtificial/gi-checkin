...
#      @visitas.push(['Viernes 8:00-12:00  - FRISA', '24']) end
  ...
  def edifica
    ...
    if Ticket.where(:ticket_conference1 => 23 , :event_id => event).count < 30 then @jueves.push(['Visita: Condotec 4:00 pm', '23']) end
...
#Cerrado 8/11    if Ticket.where(:ticket_conference1 => 7 , :event_id => event).count < 30 then @jueves.push(['Taller: Excel Avanzado 4:30 pm', '7']) end
#Cerrado 6/10    if Ticket.where(:ticket_conference1 => 8 , :event_id => event).count < 35 then @jueves.push(['Taller: Ecocreto 4:30 pm', '8']) end
    ...
    if Ticket.where(:ticket_conference2 => 19, :event_id => event).count < 15 then @viernes.push(['Visita: CEMEX 5:30 pm', '19']) end
    ...
    if Ticket.where(:ticket_conference2 => 20, :event_id => event).count < 100 then @viernes.push(['Taller: MAPEI: Refuerzo y reestructuración de elementos de concreto 4:00 pm', '20']) end


    if Ticket.where(:ticket_other => 14, :event_id => event).count < 35 then @sabado.push(['Visita: Tulé 9:00 am', '14']) end
    if Ticket.where(:ticket_other => 15, :event_id => event).count < 30 then @sabado.push(['Visita: Tulé 8:00 am', '15']) end
    if Ticket.where(:ticket_other => 22, :event_id => event).count < 35 then @sabado.push(['Visita: Cuauhtémoc 8:30 am', '22']) end
    ...
    if current_user
      ...
      if params[:paramT] != ""
        ...
        if ticket
          ...
          talleres = [['Visita: Punto Valle 5:00 pm', '1'],['Visita: Maccaferri 4:30 pm', '2'],['Visita: Torre Céntrika Elite 5:30 pm', '3'],['Visita: CEMEX 5:30 pm', '18'],['Taller: Three: Certificacion Leed y Sustentabilidad 4:30 pm', '4'],['Taller: MAPEI: Refuerzo y reestructuración de elementos de concreto 3:00 pm', '5'],['Taller: Sketchup 4:30 pm', '6'],['Taller: Excel Avanzado 4:30 pm', '7'],['Taller: Ecocreto 4:30 pm', '8'],['Visita: Condotec 4:45 pm', '9'],['Visita: Punto Valle 5:00 pm', '10'],['Visita: Arboleda 5:30 pm', '11'],['Visita: CEMEX 5:30 pm', '19'],['Taller: Vray 4:30 pm', '12'],['Taller: BIM 4:30 pm', '13'],['Taller: MAPEI: Refuerzo y reestructuración de elementos de concreto 4:00 pm', '20'],['Visita: Tulé 9:00 am', '14'],['Visita: Tulé 8:00 am', '15'],['Visita: Paseo Cumbres 8:30 am', '16'],['Visita: Torres Obispado 8:30 am', '17'], ['Visita: Torre KOI 4:00 pm', '21']]
          talleres.each do |t|

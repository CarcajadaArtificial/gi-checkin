class ConferencesController < ApplicationController
  ...
  private
    ...
    def conference_params
      params.require(:conference).permit(:conference_name, :conference_date, :conference_capacity, :conference_attendance, :conference_description, :conference_speaker, :conference_location)
    end
end

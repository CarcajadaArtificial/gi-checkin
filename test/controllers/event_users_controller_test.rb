...
class EventUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_user" do
    assert_difference('EventUser.count') do
      post event_users_url, params: { event_user: { Event_id: @event_user.Event_id, User_id: @event_user.User_id } }
    end
  ...
  test "should update event_user" do
    patch event_user_url(@event_user), params: { event_user: { Event_id: @event_user.Event_id, User_id: @event_user.User_id } }
